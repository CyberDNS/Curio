...
export default function CategoryPage() {
    ...
    return (
      <div className="flex justify-center items-center py-20">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-newspaper-900 mb-2">Category not found</h2>
          <p className="text-newspaper-600">The category "{slug}" does not exist.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div>
      ...
      />
      <NewspaperView categorySlug={slug} />
    </div>
  )
}
